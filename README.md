...
```bash
# Evaluate the top-k binary model with the alternate flattened question set
...
*   `linear_questions.json` — Flattened alternate question set used by `eval_mteb_ablation.py` by default
